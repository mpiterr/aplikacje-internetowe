...
<form action="<?php print(_APP_URL);?>/app/calc.php" method="get">
	...
	<label for="id_x">Oprocentowanie w procentach [%]: </label>
	<input id="id_q" type="text" name="q" value="<?php isset($q)?print($q):''; ?>" /><br />
...
<?php echo 'Miesieczna rata kredytu wynosi: '.$result;  ?>
